...
class UpdateTournamentPointRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'points.*.id' => 'nullable|integer|exists:tournament_points,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'points.*.id.integer' => 'IDの形式が正しくありません。',
            'points.*.id.exists' => '指定されたポイントが存在しません。',
